...
function readyPause() {
	...
	gamePhase = 1;
    document.getElementById("gatillo").style.display = "block";
    document.getElementById("l").style.display = "block";
    document.getElementById("r").style.display = "block";
    Start();
    document.getElementById("battery").innerHTML = onBatteryStatus();
}
...
function onSuccessAcceleration(acceleration) {
    alert("Accel sucess");
    alert(Number(acceleration.x));
    $('message').text(Number(acceleration.x));
}
